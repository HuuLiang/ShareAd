...
@implementation NSString (dataEncrypt)

- (NSString *)ccryptedStringWithPassword:(NSString *)password withOperation:(CCOperation)op {
...
- (NSString *)dataEncryptedWithPassword:(NSString *)password {
    return [self ccryptedStringWithPassword:password withOperation:kCCEncrypt];
}

- (NSString *)dataDecryptedWithPassword:(NSString *)password {
    return [self ccryptedStringWithPassword:password withOperation:kCCDecrypt];
}
...
//    return [self decryptedStringWithPassword:[password.md5 substringToIndex:16]];
    return [self dataDecryptedWithPassword:password];
}
