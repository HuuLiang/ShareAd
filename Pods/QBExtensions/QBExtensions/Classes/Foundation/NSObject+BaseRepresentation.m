...
//        if ([instance respondsToSelector:NSSelectorFromString(@"valueElementClass")]) {
//            valueElementClass = [instance performSelector:NSSelectorFromString(@"valueElementClass")];
//        }
//
//        if (!valueElementClass) {
//            [self setValuesForKeysWithDictionary:dic];
//        } else {
//            [dic enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
//                NSMutableArray *arr = [[NSMutableArray alloc] init];
//                [instance setObject:arr forKey:key];
//                
//                for (NSDictionary *subDic in (NSArray *)obj) {
//                    id subinstance = [[valueElementClass alloc] init];
